...
async def search_cve(cmn_opts: SearchInputCommon = Depends(SearchInputCommon),
    ...
    try:
        opts = SearchOptions(
            ...
            versionStart=cve_opts.version_start,
            versionStartInclude=cve_opts.version_start_include,
            versionEnd=cve_opts.version_end,
            versionEndInclude=cve_opts.version_end_include,
...
async def search_cpe(cmn_opts: SearchInputCommon = Depends(SearchInputCommon),
    ...
    try:
        opts = SearchOptions(
            ...
            versionStart=cpe_opts.version_start,
            versionStartInclude=cpe_opts.version_start_include,
            versionEnd=cpe_opts.version_end,
            versionEndInclude=cpe_opts.version_end_include,
