...
class SearchInputCve:
    ...
    def __init__(self, *,
        ...
        epss_score_gt: Optional[float] = Query(default=0.0, description="Greater EPSS score float to search for", alias="epss-score-gt", ge=0.0, le=1.0),
        epss_score_lt: Optional[float] = Query(default=1.0, description="Less EPSS score float to search for", alias="epss-score-lt", ge=0.0, le=1.0),
        epss_perc_gt: Optional[float] = Query(default=0.0, description="Greater EPSS percentile float to search for", alias="epss-perc-gt", ge=0.0, le=1.0),
        epss_perc_lt: Optional[float] = Query(default=1.0, description="Less EPSS percentile float to search for", alias="epss-perc-lt", ge=0.0, le=1.0),
