...
CPE23_REGEX_STR: str = r'cpe:2\.3:[aho\*\-](:(((\?*|\*?)([a-zA-Z0-9\-\._]|(\\[\\\*\?!"#$$%&\'\(\)\+,\/:;<=>@\[\]\^`\{\|}~]))+(\?*|\*?))|[\*\-])){3,5}(:(((\?*|\*?)([a-zA-Z0-9\-\._]|(\\[\\\*\?!"#$$%&\'\(\)\+,\/:;<=>@\[\]\^`\{\|}~]))+(\?*|\*?))|[\*\-])){0,5}'
...
class SearchOptions(BaseModel):
    ...
    versionStart: Optional[str] = Field(default=None, description="Start version filter for the specified CPE. Only applicable if 'cpe23' is provided.", alias="version-start")
    versionStartInclude: Optional[bool] = Field(default=False, description="Indicates whether the 'version-start' is inclusive. Only applicable if 'version-start' is specified.", alias="version-start-include")
    versionEnd: Optional[str] = Field(default=None, description="Start version filter for the specified CPE. Only applicable if 'cpe23' is provided.", alias="version-end")
    versionEndInclude: Optional[bool] = Field(default=False, description="Indicates whether the 'version-end' is inclusive. Only applicable if 'version-end' is specified.", alias="version-end-include")
